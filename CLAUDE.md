...
This project is indexed by GitNexus as **API** (1700 symbols, 5183 relationships, 147 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

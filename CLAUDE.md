...
This project is indexed by GitNexus as **API** (1301 symbols, 4351 relationships, 113 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

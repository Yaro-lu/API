...
This project is indexed by GitNexus as **API** (1925 symbols, 6009 relationships, 167 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
